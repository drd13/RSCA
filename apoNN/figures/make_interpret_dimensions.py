...
plt.scatter(allStar_occam["Fe_H"],V_occam.val[:,-1],s=3,color="orange",label="clusters")
...
plt.scatter(allStar_occam["Fe_H"],V_occam.val[:,-2],s=3,color="orange",label="clusters")
plt.xlim(-2.0,0.7)
plt.ylim(-30,40)
...
plt.scatter(allStar_occam["Fe_H"],V_occam.val[:,-3],s=3,color="orange",label="clusters")
plt.xlim(-2.0,0.7)
plt.ylim(-20,50)
...
plt.scatter(allStar_occam["Fe_H"],allStar_occam["Mg_Fe"],s=3,color="orange",label="cluster stars")
plt.xlim(-2.0,0.85)
plt.ylim(-0.2,0.5)
plt.xlabel("[Fe/H]")
plt.ylabel("[Mg/Fe]")
